...
def build_about():
  ...
  <section class="section-white">
    <div class="container" style="max-width:760px">
      <p>Espacio Dual es donde dos dimensiones convergen: la luz y la sombra, el cuerpo y el alma, lo consciente y lo inconsciente. Un contenedor sagrado donde exploramos la dualidad inherente al ser humano — no para resolverla, sino para habitarla con consciencia y amor.</p>
      <p>Aquí no hay caminos prescritos. Cada proceso es orgánico, único como el ser que lo transita. Patria acompaña desde la escucha profunda y sin juicio, sosteniendo un espacio donde todo lo que eres tiene cabida: tus sombras y tus luces, tus contradicciones y tu grandeza.</p>
      <p>A través del Coaching de Vida, la Consejería Espiritual, el Reiki, la Meditación y la transformación consciente de tus Hábitos, te acompañamos a restaurar el balance natural de tu esencia y a reconectar con tu presencia divina.</p>
      <p>Comienza tu viaje hacia una nueva consciencia de ser, estar y sentir — en un espacio seguro, íntegro y auténtico.</p>
      <div class="text-center mt-40">
